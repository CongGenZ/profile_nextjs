    ...
    id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='text-center mb-2 text-lg font-Ovo'>Introduction</motion.h4>
       ...
       className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
         ...
         className='flex-1'>
                <p className='mb-10 max-w-2xl font-Ovo'>I am experienced Frontend Deverloper with over a decade of professional expertise in 
                    the field Throughout my career, i have had the privilege of collaborating
                    with prestigious oraganzation,
