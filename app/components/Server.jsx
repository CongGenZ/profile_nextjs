...
const Server = () => {
  return (
    ...
    id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'> I am  frontend developer from  Nam Dinh, VN with 10 year of experience 
      ...
      className='grid  grid-cols-auto  gap-6 my-6'>
